...
причиной; есть пакетная обработка и сводная выгрузка по всем. Повторно загруженный снимок
отклоняется, а новые снимки уже загруженного исследования добавляются к нему.
...
Повторная обработка решение врача не стирает.
