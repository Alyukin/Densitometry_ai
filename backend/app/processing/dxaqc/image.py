...
# Кадр не пустой по проверке is_dxa_like, но тела или кости в нём нет. Это не
# снимок позвоночника или бедра — нестандартные данные, а не отказ и не вердикт.
REASON_EMPTY = "пустой кадр"
REASON_NO_BONE = "кость не найдена"
NON_STANDARD_REASONS = (REASON_EMPTY, REASON_NO_BONE)
